package com.woodssong.cryptographysample.SecureRandom;

import java.security.NoSuchAlgorithmException;
import java.security.SecureRandom;

/**
 * @author Joe Prasanna Kumar This program provides the functionality for
 *         Generating a Secure Random Number.
 * 
 *         There are 2 ways to generate a Random number through SecureRandom. 1.
 *         By calling nextBytes method to generate Random Bytes 2. Using
 *         setSeed(byte[]) to reseed a Random object
 * 
 */
